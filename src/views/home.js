    ...
    render() {
        ...
        return (
            <div className='page-content home'>
                ...
                <PageHero bgVideo="video.mp4">
                    <h1 className='page-hero-header'>We Build <span className='text-yellow'>Games</span></h1>
                </PageHero>
                ...
                <section className='section-3 bg-black bg-clip-badge'>
                    <div className='layout-width'>
                        ...
                        <div className='d-flex justify-content-between flex-wrap'>
                            ...
                            <Link to="" className="f-32 fw-700 text-gradient-fill mt-3">View All 
                                <span className='icon'>
                            ...
                            <div className='grid-2 column-gap-lg'>
                                ...
                                <div className='video-container justify-self-lg-end'>
                                    <div className='outer-container'>
                                        <div className='overlay'></div>
                                        <div className='inner-container'>
                                            <video src={ process.env.PUBLIC_URL + "/assets/video/Tom Clancys Ghost Recon Breakpoint- New Karambit Takedown.mp4" } autoPlay loop muted />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='grid-2 column-gap-lg'>
                                ...
                                <div className='video-container justify-self-lg-end'>
                                    <div className='outer-container'>
                                        <div className='overlay'></div>
                                        <div className='inner-container'>
                                            <video src={ process.env.PUBLIC_URL + "/assets/video/Cartoon Crush - Android Game Trailer - Eggs Portrait.mp4" } autoPlay loop muted />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section className='section-4'>
                    ...
                    <div className='layout-width'>
                        ...
                        <div className='grid-2-row'>
                            ...
                            <p className='text-black f-32 fw-400'>
                            Gudu Studios Limited has game competiitions that are organised peroidically with our partners. Get informed about all our upcoming competitions and events which we would organise.
                            </p>
                        </div>

                        <Link to="" className='f-32 fw-700 link-primary'>See more</Link>
